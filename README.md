...
[![Version](https://img.shields.io/badge/version-0.6.4-blue)](https://github.com/johnzastrow/metadatamgr/releases)
...
| Version | Highlights |
|---------|-----------|
| **0.6.4** | Fix metadata save to GeoPackage (wrong API method) |
